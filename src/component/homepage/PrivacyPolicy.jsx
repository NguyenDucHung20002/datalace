...
export default function PrivacyPolicy() {
  return (
    <>
      <div className="privacy" style={{ marginTop:"40px", padding: '7%', background:'#33363f', color:'white' }}>
        <h1
          style={{
            textShadow: "black 0px 4px 4px",
            fontWeight: "bold",
          }}
        >
          Privacy Policy
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Datalace.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Datalace, accessible from{" "}
              <a style={{color:'#67D3DF'}}
                href="https://datalace.org/"
        ...
        <ul>
          <li>By email: contact@hephaestus-tech.org</li>
        </ul>
      </div>
      <Footer/>
    </>
